  ...
  <div>
    ...
    <main class="container">
      <div class="billing-section">
        ...
        <p>
          Here you can view your current bills, payment history, and make new
          payments securely.
        </p>
        <div class="dashboard-grid">
          <div class="card card-view-bills">
            ...
            <button class="cta" @click="showModal('viewBillsModal')">
              View Bills
            </button>
          </div>
          <div class="card card-make-payment">
            ...
            <h2>Make Payment</h2>
            <p>
              Securely make payments for any pending bills using our online
              payment system.
            </p>
            <button class="cta" @click="showModal('makePaymentModal')">
              Make Payment
            </button>
          </div>
          <div class="card card-billing-history">
            ...
            <p>
              View your complete billing history and download statements if
              needed.
            </p>
            <button class="cta" @click="showModal('billingHistoryModal')">
              View History
            </button>
          </div>
        </div>
    ...
    <div id="makePaymentModal" class="modal">
      <div class="modal-content">
        <span class="close" @click="closeModal('makePaymentModal')"
          >&times;</span
        >
        <h2>Make Payment</h2>
    ...
    <div id="billingHistoryModal" class="modal">
      <div class="modal-content">
        <span class="close" @click="closeModal('billingHistoryModal')"
          >&times;</span
        >
        <h2>Billing History</h2>
