        ...
        <div class="form-container">
          ...
          <div class="form-section">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="gender" v-model="aRecord.gender" class="form-control">
              ...
              <div class="form-group">
                ...
                <select id="maritalStatus" v-model="aRecord.maritalStatus" class="form-control">
          ...
          <div class="form-section">
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <select id="department" v-model="aRecord.department" class="form-control">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="employment" v-model="aRecord.employment" class="form-control">
          ...
          <div class="form-section">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="idType" v-model="aRecord.idType" class="form-control">
          ...
          <div class="form-section">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="criminalRecord" v-model="aRecord.criminalRecord" class="form-control">
                  <option value="" disabled selected>Select Status</option>
              ...
              <div class="form-group">
                ...
                <select id="referenceCheck" v-model="aRecord.referenceCheck" class="form-control">
                  <option value="" disabled selected>Select Status</option>
                  <option value="Completed">Completed</option>
                  <option value="Pending">Pending</option>
                  <option value="Not Required">Not Required</option>
              ...
              <div class="form-group">
                ...
                <select id="vaccinationStatus" v-model="aRecord.vaccinationStatus" class="form-control">
                  <option value="" disabled selected>Select Status</option>
          ...
          <div class="form-footer">
            <div class="form-check">
              <input type="checkbox" id="termsCheck" v-model="aRecord.termsCheck" />
              <label for="termsCheck">I confirm all information provided is accurate and complete*</label>
            </div>
            
            <div class="form-buttons">
              <button @click="resetForm" class="btn reset-btn">Reset Form</button>
              <button @click="addRecord" class="btn pink">Submit Staff Record</button>
            </div>
          </div>
        </div>
      </div>
...
const addRecord = () => {
  ...
  const requiredFields = ['first', 'last', 'role', 'qualification', 'employment', 
                          'salary', 'dob', 'gender', 'email', 'phone', 'address']
